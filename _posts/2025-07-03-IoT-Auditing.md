...
- **Network Scanning:** *Nmap* is a staple for mapping ports/services on IP-connected devices. For broad asset discovery, *Shodan* can identify internet-facing IoT devices by service banner, helping auditors find devices that might have been overlooked.
